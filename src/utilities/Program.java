...
[Car] name: Car #1, SerialNumber: 1, maxSpeed: 400.0, acceleration: 20.0, color: RED, Number of Wheels: 4, Engine Type: FOURSTROKE
...
[SpeedBoat] name: SpeedBoat #6, SerialNumber: 6, maxSpeed: 170.0, acceleration: 5.0, color: RED, Type: SKULLING, Team: DOUBLE
[RowBoat] name: RowBoat #7, SerialNumber: 7, maxSpeed: 75.0, acceleration: 10.0, color: RED, Type: SKULLING, Team: DOUBLE
End of test.
----------
New Air Race
...
Introduction: 
[Car] name: Bob, SerialNumber: 14, maxSpeed: 220.0, acceleration: 10.0, color: BLUE, Number of Wheels: 4, Engine Type: FOURSTROKE
[Car] name: John, SerialNumber: 15, maxSpeed: 175.0, acceleration: 20.0, color: BLUE, Number of Wheels: 4, Engine Type: FOURSTROKE
...
#1 -> name: Bob, SerialNumber: 14, maxSpeed: 220.0, acceleration: 10.0, color: BLUE, Number of Wheels: 4, Engine Type: FOURSTROKE
#2 -> name: John, SerialNumber: 15, maxSpeed: 175.0, acceleration: 20.0, color: BLUE, Number of Wheels: 4, Engine Type: FOURSTROKE
...
Introduction: 
[RowBoat] name: Bob, SerialNumber: 20, maxSpeed: 220.0, acceleration: 10.0, color: BLUE, Type: SKULLING, Team: DOUBLE
[SpeedBoat] name: John, SerialNumber: 21, maxSpeed: 175.0, acceleration: 20.0, color: BLUE, Type: SKULLING, Team: DOUBLE
Strat Race!
Bob Has a new mishap! (false, 3, 0.44)
John Has a new mishap! (false, 2, 0.04)
Race Compleated!
#0 -> name: Bob, SerialNumber: 20, maxSpeed: 220.0, acceleration: 10.0, color: BLUE, Type: SKULLING, Team: DOUBLE
#1 -> name: John, SerialNumber: 21, maxSpeed: 175.0, acceleration: 20.0, color: BLUE, Type: SKULLING, Team: DOUBLE
*/